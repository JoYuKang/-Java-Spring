...
-- insert into book(`id`,`name`,`publisher_id`) values (1,'JPA 고아객체 확인 책',1 );
--
-- insert into book(`id`,`name`,`publisher_id`) values (2,'토비의 Spring',1  );
--
-- insert into book(`id`,`name`,`publicher_id`) values (3,'이건 가짜 책',1 );
